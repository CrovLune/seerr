...
// TypeORM's test datasource imports every TypeScript file in this directory.
// Do not register these synchronize-based tests while the migration test loads
// the entity metadata through that glob.
if (
